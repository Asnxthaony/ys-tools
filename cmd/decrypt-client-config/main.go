...
func main() {
	req, err := http.NewRequest(http.MethodGet, "https://dispatchcnglobal.yuanshen.com/query_region_list?version=CNRELWin3.6.0&lang=2&platform=3&binary=1&channel_id=1", nil)
	if err != nil {
		panic(err)
	}
